...
function Profile() {
  ...
  const handleProfile = async (e) => {
    ...
    try {
      ...
      dispatch(setUserData(result.data)); // backend returns user directly
      navigate("/");
    } catch (error) {
  ...
  return (
    <div className="w-full h-[100vh] bg-slate-200 flex flex-col justify-center items-center gap-[20px]">
      ...
      >
        ...
        <div className="absolute bottom-4 right-4 w-[35px] h-[35px] rounded-full bg-[#20c7ff] flex justify-center items-center shadow-gray-400 shadow-lg">
